...
from daily_tasker.utils.constants import LOGGER_DIR, LOGGER_NAME
...
def setup_logging(
    ...
    :type log_filename_prefix: str or None

    :param log_level: Minimum log level for console output.
                      One of: ``"DEBUG"``, ``"INFO"``, ``"WARNING"``, ``"ERROR"``.
                      Defaults to ``"INFO"``.
    :type log_level: str or None

    :param log_dir: Directory where log files will be saved.
                    Defaults to ``LOGGER_DIR`` (typically ``./logs``).
